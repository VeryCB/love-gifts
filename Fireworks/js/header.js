...
JSDoIt.Header = new function() {
    ...
    return {
        ...
        get_submenu : function( el ) {
            var id = el.id;
            return document.getElementById( "header_submenu_"+id.substr( id.length-1 ) );
        }
    }
}
 ...
 * 
 * modified by mash, put it under JSDoIt namespace
 */
 ...
 * @author Klaus Hartl/klaus.hartl@stilbuero.de
 */
JSDoIt.cookie = function(name, value, options) {
